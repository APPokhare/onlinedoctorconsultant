...
import com.onlinedoctorconsultant.repositories.ReviewsRepository;
...
public class ReviewsService implements IBaseService<Reviews, Long> {
	...
	public Reviews update(Long id, Reviews entity) {
		...
		reviews.setStars(entity.getStars());
	...
	public List<Reviews> findAllReviewsOfDoctor(Long doctorId) {
		return reviewsRepository.findAllReviewsOfDoctor(doctorId);
	}
