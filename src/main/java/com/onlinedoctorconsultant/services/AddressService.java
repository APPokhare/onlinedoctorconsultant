...
import com.onlinedoctorconsultant.repositories.AddressRepository;
import com.onlinedoctorconsultant.repositories.AddressTypeRepository;
...
public class AddressService implements IBaseService<Address, Long> {
	...
	public Address findOneUserAddressByAddressType(String username, String addressType) {
		...
		System.err.println(")))))))))))))))))))))))))))))))))))))))"+addressTypeObj.toString());
